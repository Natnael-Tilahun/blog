...
<!-- about page  -->
   <div class="overflow-x-hidden border-gray-200 border-b">
    ...
    <div class="overflow-x-hidden ">
      <div id="contact" style="position: relative; top: -40px; left: 0" class="bg-gray-50"/>
          ...
          <div class="text-lg sm:text-lg mb-16">
            <form action="#" class="mb-12">
              ...
              <div class="flex justify-end w-full">
                  <input type="submit" value="Submit" class="block bg-gray-800 hover:bg-green-800 text-white text-sm font-semibold tracking-wide uppercase shadow rounded cursor-pointer px-6 py-3">
              </div>
          </form>
          </div>
        </div>
